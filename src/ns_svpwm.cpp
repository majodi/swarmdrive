...
#endif
    float currentSignalFraction = (float)((m->_rpsResolution - m->_angleR) % m->_signalRotationAngleR) / m->_signalRotationAngleR;
    m->commutate((currentSignalFraction * m->_arraySize) + 90);
#ifdef NS_TIMER_DEBUG_PIN
